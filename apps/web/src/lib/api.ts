...
export const authApi = {
  ...
  me: async () =>
    makeRequest<{ user: any }>('/auth/me'),
};

// Notes API
export const notesApi = {
  list: async (params?: { page?: number; limit?: number; folder?: string }) =>
  ...
  create: async (note: { title: string; content: any; folder?: string; tags?: string[] }) =>
    makeRequest<{ note: any }>('/notes', {
      method: 'POST',
      body: JSON.stringify(note),
    }),
  
  update: async (id: string, note: { title?: string; content?: any; folder?: string; tags?: string[] }) =>
    makeRequest<{ note: any }>(`/notes/${id}`, {
      method: 'PUT',
      body: JSON.stringify(note),
    }),
...
export const searchApi = {
  search: async (params: { q: string; limit?: number; offset?: number; folder?: string; tags?: string[] }) =>
